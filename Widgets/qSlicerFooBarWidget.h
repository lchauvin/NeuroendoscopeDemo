...
#include "qSlicerNeuroendoscopeDemoModuleWidgetsExport.h"

class qSlicerFooBarWidgetPrivate;

/// \ingroup Slicer_QtModules_NeuroendoscopeDemo
class Q_SLICER_MODULE_NEUROENDOSCOPEDEMO_WIDGETS_EXPORT qSlicerFooBarWidget
  : public QWidget
{
  Q_OBJECT
public:
